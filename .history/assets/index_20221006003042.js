    ...
    const renderCard = () => {
        html = `<div class="card">
        <h3>Elige tu pokemon favorito.</h3>
        <img id="img-pokemon" src="/img/descarga.jpg" alt="Avatar" style="width:30%">
        <div class="container">
            <p>Nombre: <span class="texts" id="nombre-pokemon">Sin datos.</span></p>
            <p>Tipos: <span class="texts" id="tipo-pokemon">Sin datos.</span></p>
            <p>Altura: <span class="texts" id="altura-pokemon">Sin datos.</span>.</p>
            <p>Peso: <span class="texts" id="peso-pokemon">Sin datos.</span>.</p>
        </div>`
